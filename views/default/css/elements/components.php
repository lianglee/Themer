...
.elgg-state-success {
	...
	<?php if(!empty($Themer->notification_success_bgcolor)){ ?>
		background-color: <?php echo $Themer->notification_success_bgcolor;?> !important;
	<?php } ?>	
	<?php if(!empty($Themer->notification_success_color)){ ?>
		color: <?php echo $Themer->notification_success_color;?> !important;
	<?php } ?>			
}
.elgg-state-error {
	background-color: #F00;
	<?php if(!empty($Themer->notification_error_bgcolor)){ ?>
		background-color: <?php echo $Themer->notification_error_bgcolor;?> !important;
	<?php } ?>	
	<?php if(!empty($Themer->notification_error_color)){ ?>
		color: <?php echo $Themer->notification_error_color;?> !important;
	<?php } ?>			
}
.elgg-state-notice {
